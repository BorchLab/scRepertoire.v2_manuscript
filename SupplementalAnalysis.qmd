...
CellDimPlot(object.merge, 
  ...
  guides(color = "none") + 
  theme_void()
ggsave("output/viz/SupplementalFig2D_1.png", height = 3, width = 3.5, dpi = 600)
...
CellStatPlot(object.merge, 
             ...
             position = "stack") + 
  guides(fill = "none")
ggsave("output/viz/SupplementalFig2D_2.pdf", height = 3, width = 2,)
...
ggsave("output/viz/SupplementalFig2E.pdf", height = 3, width = 4)
